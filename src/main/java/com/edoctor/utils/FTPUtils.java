...
public class FTPUtils {
    ...
    //ftp服务器地址
    private static final String hostname = "10.10.119.17";//外网IP:219.150.56.236，内网IP:10.10.119.17
    ...
    //ftp登录密码
    private static final String password = "EDoctor666";
